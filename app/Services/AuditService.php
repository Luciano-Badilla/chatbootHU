...
class AuditService
{
    protected const FIELD_LABELS = [
        ...
        'whatsapp.waba_id' => 'WABA ID',
        'whatsapp.phone_number_id' => 'Phone number ID',
        'whatsapp.webhook_verify_token' => 'Webhook verify token',
        'alephoo.base_url' => 'Base URL de API Turnos',
        'alephoo.api_key' => 'API key de API Turnos',
        'alephoo.timeout' => 'Timeout de API Turnos',
        'alephoo.enabled_endpoints' => 'Endpoints habilitados',
        'alephoo_v3.base_url' => 'Base URL de Alephoo',
        'alephoo_v3.username' => 'Usuario de Alephoo',
        'alephoo_v3.password' => 'Contraseña de Alephoo',
        'alephoo_v3.timeout' => 'Timeout de Alephoo',
        'autogestion.base_url' => 'Base URL de autogestion',
        'autogestion.token' => 'Token de autogestion',
        'autogestion.timeout' => 'Timeout de autogestion',
    ...
    protected function formatAuditValue(mixed $value, string $key = ''): ?string
    {
        ...
        if ($key === 'type') {
            return match ((string) $value) {
                ...
                'person_create' => 'Alta de paciente',
                'appointment_lookup' => 'Consulta de turnos activos',
                'appointment_create' => 'Sacar turno',
                'appointment_cancel' => 'Cancelar turno',
                'specialty_search' => 'Buscar especialidad',
                'doctor_select' => 'Elegir profesional',
                'availability_select' => 'Elegir fecha y horario',
                'health_insurance_select' => 'Elegir obra social',
                'health_insurance_plan_select' => 'Elegir plan',
                'image' => 'Imagen',
                'document' => 'Documento',
                'video' => 'Video',
                'audio' => 'Audio',
