...
class AuditService
{
    protected const FIELD_LABELS = [
        ...
        'person_lookup.base_url' => 'Base URL de consulta de personas',
        'person_lookup.api_key' => 'API key de consulta de personas',
        'person_lookup.timeout' => 'Timeout de consulta de personas',
        'person_lookup.enabled_endpoints' => 'Endpoints habilitados',
